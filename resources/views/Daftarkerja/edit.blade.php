...
<x-app-layout>
    <section class="text-gray-600 body-font overflow-hidden">
        <div class="w-full md:w-1/2 py-24 mx-auto">
            ...
            @endif
            <form
                action="{{ route('Daftarkerja.update', $daftarKerja->id) }}"
                method="post"
                ...
                <div class="mb-4 mx-2">
                    ...
                    <div class="mb-4 mx-2">
                        ...
                        <x-text-input
                            ...
                            type="text"
                            name="tags"
                            :value="implode(', ', $daftarKerja->tags->pluck('name')->toArray())" 
                    ...
                    <div class="mb-4 mx-2">
                        ...
                        <textarea
                            ...
                            name="content"
                        >{{ $daftarKerja->content }}</textarea>
                    </div>

                <button type="submit" class="block w-full items-center bg-indigo-500 text-white border-0 py-2 focus:outline-none hover:bg-indigo-600 rounded text-base mt-4 md:mt-0">Update</button>
            </form>
        </div>
    </section>
</x-app-layout>
